  ...
  <section class="box editor-panel">
    ...
    <section class="search-fields-panel">
      <div class="section-label-row mb-3">
        ...
        <span class="tag is-light is-small">{{ t('dashboard.tabsSettings.searchParamsTag') }}</span>
      </div>
      ...
      <div class="cmpact-row">
        <div class="toggle-section cmpact-toggle">
          <label class="label is-sr-only">{{ t('dashboard.tabsSettings.resultTypeLabel') }}</label>
